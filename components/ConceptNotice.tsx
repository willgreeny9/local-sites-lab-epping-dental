...
const storageKey = "epping-dental-concept-notice-dismissed-v8";
        ...
        <div className="concept-backdrop" role="presentation">
          ...
          >
            ...
            <h2 id="concept-title" ref={titleRef} tabIndex={-1}>
              A clearer website for a High Street dental practice.
            </h2>
            <p id="concept-description">
              William Green at Local Sites Lab built this sample site for{" "}
              <strong>Epping Dental</strong> to show how clearer treatment pages and trust
              signals could help local patients call or visit with confidence. This is not the live or official site — the business did not ask for it and has not approved it.
            </p>
            <div className="concept-actions">
              <button type="button" className="button" onClick={dismiss}>
                Continue to Epping Dental
              </button>
